...
import { ExpandIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon } from "@/components/icons";

const ICONS = [ExpandIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon];
