...
export default async function OverOnsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Over ons"
        h1="Gespecialiseerd in vergunningtekeningen voor uitbouwen"
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <Reveal delay={100} className="mt-8 space-y-5 text-brand-ink-muted">
            <p>
              ...
              zich specifiek richt op vergunningtekeningen voor uitbouwen.
            </p>
            <p>
              Die specialisatie maakt het verschil: bij een uitbouw breekt u de bestaande
              achtergevel open, en dat vraagt om een andere technische onderbouwing dan een
              aanbouw zonder gevelopening. Doordat we dagelijks met dit type project werken, weten
              we precies waar een toetser op let en waar een
